        ...
        ProfessionalExperience: [
            {
                ...
                EndDate: 'Current',
                Desc: 'Team lead responsible for designing, developing, and maintaining a call center web application for the purpose of handling Nelnet federal loan servicing of borrower loans using Angular (and AngularJS), .NET MVC, jQuery, and web design libraries like bootstrapJS and jquery-ui. Also working a new effort to migrate our three major web apps to AWS. Team lead responsibilities include facilitating code reviews, approving change set check ins, managing merging and branching, and deploying new features to our production environments.'
            },
            {
                JobTitle: 'Software Engineer',
...
var ReturnXmas = function () {
    ...
    background.append("<span style='float: left;'>" + 
